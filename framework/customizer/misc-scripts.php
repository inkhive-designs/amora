...
$wp_customize->add_control(
    new Amora_WP_Customize_Upgrade_Control(
        ...
        array(
            ...
            'description' => __('Currently We are Offering Free Email Support with our theme. If you have any queries or require help please <a target="_blank" href="https://inkhive.com/product/amora/">Read our FAQs</a> and if your problem is still not solved then contact us. <br><br> If you are looking for more features in your site like Unlimited Colors, More Layouts, Better Pages, More Social Icons, More Skins, More Widgets then please consider upgrading to <a href="#" target="_blank">Amora Plus</a>.','amora'),
